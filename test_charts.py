"""Smoke test: charts + telegram module. pytest -- Teil der probebot-Test-Suite."""
import sys
...
def test_charts_and_telegram():
    ...
    assert p1, "overview_chart fehlgeschlagen"
    ...
    assert p2, "correlation_chart fehlgeschlagen"
